...
export default function LocationPerformancePage() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'average-performer': return '⚖️'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link href="/comparative/location-performance/revenue-variance" 
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-xs font-normal text-blue-600">View Details →</span>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs">
              ...
              <span className="font-bold text-black dark:text-white">₹4,15,000</span>
            </div>
            <div className="flex justify-between text-xs">
        ...
        <Link href="/comparative/location-performance/profit-margin-variance" 
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs">
              ...
              <span className="font-bold text-green-600">Chanakyapuri (₹1.3L)</span>
            </div>
            <div className="flex justify-between text-xs">
        ...
        <Link href="/comparative/location-performance/customer-satisfaction-spread" 
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs">
              ...
              <span className="font-bold text-black dark:text-white">4.2 ⭐</span>
            </div>
            <div className="flex justify-between text-xs">
